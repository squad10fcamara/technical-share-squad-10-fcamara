  ...
  return (
    <div className="relative pb-2 h-full justify-center items-center">
      <div className="flex flex-col pb-5">
        ...
        {user ? (
          <div className="flex flex-col justify-center items-center mt-2 lg:h-4/5 rounded-lg bg-gray-200">
            ...
            <div className="mt-3 capitalize text-gray-600 text-lg font-semibold">
              <span>{user.expertise}</span>
            </div>
            <div className="mt-5 w-full rounded-lg p-8 pb-12 bg-gray-200">
